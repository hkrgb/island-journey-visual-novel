(async()=>{
 ...
 finally{const script=document.createElement('script');script.src='game-core.js?v=20';script.onload=function(){var p=document.createElement('script');p.src='stats-overlay.js?v=1';document.body.appendChild(p)};document.body.appendChild(script)}
})();
